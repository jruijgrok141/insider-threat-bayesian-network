...
\section*{References}
Axelrad, E. T., Sticha, P. J., Brdiczka, O., \& Shen, J. (2013). A Bayesian network model for predicting insider threats. \textit{IEEE Security and Privacy Workshops}, 82--89.
...
Greitzer, F. L., et al.\ (2012). Identifying at-risk employees: Modeling psychosocial precursors of potential insider threats. \textit{HICSS}, 2392--2401.

Koller, D., \& Friedman, N. (2009). \textit{Probabilistic Graphical Models}. MIT Press.

Scutari, M., \& Denis, J.-B. (2021). \textit{Bayesian Networks: With Examples in R} (2nd ed.). Chapman and Hall/CRC.
