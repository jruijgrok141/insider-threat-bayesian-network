...
|------|-----------|-------------|-------------|---------|
| 100 | HillClimb | 0.769 | 0.154 | 3 |
| 100 | MIIC | 0.769 | 0.615 | 3 |
| 500 | HillClimb | 1.000 | 0.500 | 0 |
...
|------|-----------|------------------------------|------------------------------|
| 100 | HillClimb | 0.788 [0.564, 0.933] | 0.367 [0.097, 0.714] |
| 100 | MIIC | 0.807 [0.596, 0.933] | 0.390 [0.097, 0.703] |
| 500 | HillClimb | 0.961 [0.889, 1.000] | 0.506 [0.235, 0.875] |
| 500 | MIIC | 0.978 [0.917, 1.000] | 0.797 [0.591, 1.000] |
| 1000 | HillClimb | 0.931 [0.811, 1.000] | 0.430 [0.000, 0.784] |
...
| Model | AUC | Accuracy |
|-------|-----|----------|
| Original BN + noisy-OR CPT | 0.746 | 0.69 |
...
|-------|---------------------|---------------------------|
| Original BN + noisy-OR CPT | 0.735 [0.627, 0.822] | 0.695 [0.609, 0.753] |
...
All analysis code, the reproducible Jupyter notebook, exported report figures, and supplementary materials are publicly available at [https://github.com/jruijgrok141/insider-threat-bayesian-network](https://github.com/jruijgrok141/insider-threat-bayesian-network) (MIT license). Numeric tables in §3.2–3.4 match `report/figures/*.csv`, generated by `report/export_figures.py` from the pinned dataset `report/data/synthetic_cases_n2000_seed42.csv` and cached classification-stability seeds in `report/data/classification_stability/`. Structure stability uses 30 resamples in `export_figures.py`; the notebook reproduces classification stability and single-run structure learning with the same pinned inputs. No identifiable employee or operational security records were used.
