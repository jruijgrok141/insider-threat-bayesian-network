...
**Data and code availability.** All analysis code, the reproducible Jupyter notebook, and exported figures are at [github.com/jruijgrok141/insider-threat-bayesian-network](https://github.com/jruijgrok141/insider-threat-bayesian-network) (MIT license). Tables in §3 match `report/figures/*.csv` from `export_figures.py` and pinned synthetic data; no identifiable employee records were used.
